...
describe("SearchParams Unit Tests", () => {
  test("page prop", () => {
    ...
    arrange.forEach((it) => {
      expect(new SearchParams({ page: it.page as any }).page).toBe(it.expected);
    });
  });
  ...
  test("perPage prop", () => {
    ...
    arrange.forEach((it) => {
      expect(new SearchParams({ perPage: it.perPage as any }).perPage).toBe(
        it.expected
      );
    });
  });
  ...
  test("sort prop", () => {
    ...
    arrange.forEach((it) => {
      expect(new SearchParams({ sort: it.sort as any }).sort).toBe(it.expected);
    });
  });
  ...
  test("sortDir prop", () => {
    ...
    arrange.forEach((it) => {
      expect(
        new SearchParams({ sort: "sort", sortDir: it.sortDir as any }).sortDir
      ).toBe(it.expected);
    });
  });
  ...
  test("filter prop", () => {
    ...
    arrange.forEach((it) => {
      expect(new SearchParams({ filter: it.filter as any }).filter).toBe(
        it.expected
      );
    });
  });
